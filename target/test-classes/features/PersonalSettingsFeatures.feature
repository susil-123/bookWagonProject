...
Feature: Check if the personal settings working correctly
  ...
  Scenario: Trying to update personal settings using valid test case
    ...
    And I fill valid "<FirstName>", "<LastName>", "<Email>", "<Fax>", "<ProfileName>", "<PublicWishlist>", "<NewsletterSub>", "<TransMailSub>", "<PromoMailSub>", "<CountryCode>", "<MobileNumber>" credentials
    #And I fill valid credentials #for ddt
